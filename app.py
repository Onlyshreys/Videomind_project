...
class AIVideoSummarizer:
    ...
    def header(self):
        ...
        st.markdown('<div class="main-title">🎬 VideoMind : AI Powered Video Intelligence Platform</div>', unsafe_allow_html=True)
        st.markdown('<div class="sub-title">Analyze videos, extract insights, and chat with content</div>', unsafe_allow_html=True)
    ...
    def run(self):
        ...
        st.set_page_config(
            page_title="VideoMind : AI Powered Video Intelligence Platform",
            page_icon="🎬",
            layout="wide"
        )
